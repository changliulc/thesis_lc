...
function f=b(t1,t2,t3,t4,t5,t6,t7,t8,t9,t10)
%%
%数据读取
[data_left_num,~,data_left]=xlsread('data0526.xlsx',1,'A1:L212');
...
theta=[t1,t2,t3,t4,t5,t6,t7,t8,t9,t10];
...
m=[theta(1:3);theta(4:6);];%给定初始值 单位是Am² 需要迭代计算的值
[n,~]=size(m);
