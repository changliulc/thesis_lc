...
function f=Optimfun3(t1,t2,t3,t4,t5,t6,t7,t8,t9)
%%
%数据读取
...
%需要迭代计算的值：mx1 my1 mz1  mx2 my2 mz2 mx3 my3 mz3 dx1 dx2 z0 
m=[theta(1:3);theta(4:6);theta(7:9)];%给定初始值 单位是Am² 需要迭代计算的值
[n,~]=size(m);
x0=-v*T*L/2;y0=-1.8;z0=-0.7;%给定的y0从视频中观察得到
% dx1=theta(10);dx2=theta(11);
dx1=3;dx2=0.8;
k=1:1:L;
