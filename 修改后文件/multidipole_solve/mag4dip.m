clc;close all;clear;
%数据读取
[data_left_num,~,data_left]=xlsread('data0526.xlsx',2,'A1:L158');
% arrive_status=2;
% leave_status=4;
% 
% %%先计算该表中有多少辆车
...
F=@(t)Optimfun4(t(1),t(2),t(3),t(4),t(5),t(6),t(7),t(8),t(9),t(10),t(11),t(12),t(13),t(14),t(15),t(16));%y0已知
%12个磁偶极矩，dx1,dx2,dx3  z1
theta=[60,100,-50,60,100,-50,60,100,-50,60,100,-50,0.8,1.6,2.4,-0.7];%初值
%小型车
lb=[-1000*ones(1,12),0,0,0,-1.5];%未知数的约束下界lb  约束上界ub
ub=[1000*ones(1,12),5,5,5,-0.3];
...
th=theta;
m=[th(1:3);th(4:6);th(7:9);th(10:12)];%给定初始值 单位是Am² 需要迭代计算的值
[n,c]=size(m);
x10=-v*T*L/2;y0=-1.6;z0=th(16);%给定的y0从视频中观察得到
dx1=th(13);dx2=th(14);dx3=th(15);
k=1:1:L;
